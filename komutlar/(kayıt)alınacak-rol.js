...
.setDescription(`❌ Kayıt Olunca Alınacak Rol Sıfırlandı ! `)//pythonic//pythonic//pythonic//pythonic//pythonic
...
.setColor('BLACK')
.setDescription(`⛔ Kayıt Olunca Alınacak Rolü Lütfen Belirtiniz ! `)//pythonic//pythonic//pythonic
.setThumbnail(client.user.avatarURL())
...
exports.conf = {//pythonic//pythonic
  enabled: true,
  guildonly: false,
  aliases: ['unregister-rol', 'unregister'],
